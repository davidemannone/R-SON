...
test('not objects', function () {
    ...
    var myDeserializedNumber = System.Reflection.deserialize(mySerialized);
    equal(myDeserializedNumber, n, "my deserialized number");
    var d = new Date();
    mySerialized = System.Reflection.serialize(d);
    notEqual(mySerialized.length, 0, "my serialized number");
    var myDeserializedDate = System.Reflection.deserialize(mySerialized);
...
test('serializer of window classes', function () {
    var str = "ciao";
    var n = 1;
    var obj = new Class(str, n);
    var mySerialized = System.Reflection.serialize(obj, "window");
...
function createobjs(max, c) {
    if (max === void 0) { max = 1; }
    if (c === void 0) { c = new NameSpace.Class("start", new Date(), /ciao/g); }
    var t = c;
    var date = new Date();
    var regex = /ciao/g;
    for (var i = 0; i < max; i++) {
